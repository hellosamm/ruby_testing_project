...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context "when the random number is 3 and the previous step is 10" do
  ...
  describe '#play' do
    ...
    context 'when the random number is 10003' do
      subject(:game_thousand) {described_class.new(10003)}
